...
/**
 * Story 3 — client mode with the full toolbar: ViewSwitcher, FilterButton +
 * FilterChips, Group popover, ColumnPanel, undo/redo and CSV export, over the
 * fixture (r1..r5) plus 60 generated rows (x001..x060).
 */

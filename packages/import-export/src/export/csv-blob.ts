/**
 * CSV export as a browser Blob, built on one chunked generator that the Node
 * stream writer (`./csv`) shares, so both paths produce byte-identical output.
 * This file must stay free of `node:` references: it is on the browser entry.
 */
